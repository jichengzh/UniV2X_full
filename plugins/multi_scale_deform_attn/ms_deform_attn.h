...
class MultiScaleDeformableAttentionPlugin: public IPluginV2DynamicExt {
public:
    MultiScaleDeformableAttentionPlugin() noexcept {};
    MultiScaleDeformableAttentionPlugin(PluginFieldCollection const& fc) noexcept;
    MultiScaleDeformableAttentionPlugin(const std::string name, const void* serialData, size_t serialLength); 

    ~MultiScaleDeformableAttentionPlugin() override = default;
    ...
    const std::string mName = "MSDAPlugin"; 
    PluginTensorDesc mInputTensor;
    PluginTensorDesc mOutputTensor;
}; // class MultiScaleDeformableAttentionPlugin


class MultiScaleDeformableAttentionPluginCreator : public nvinfer1::IPluginCreator {
public:
...
}; // class MultiScaleDeformableAttentionPluginCreator
