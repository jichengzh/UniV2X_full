...
- `${V2X_DATA_ROOT}/dsmap_cliff_phaseA.log`

Raw H800 result pattern:

```text
${V2X_DATA_ROOT}/V2Xverse_apknob/results/
...
```bash
${V2X_HOME}/miniconda3/envs/v2xverse/bin/python \
  ${V2X_ROOT}/multi_agent/real_test/ds_map_build_v2.py
```
