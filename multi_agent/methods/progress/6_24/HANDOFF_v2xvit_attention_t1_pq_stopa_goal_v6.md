...
```text
${V2X_DATA_ROOT}/v2x_t1_attention/logs/attention_e2e_pq_v1/hmsa_type_dispatch_coverage_full_v1.json
```
...
```text
host: ${V2X_REMOTE_USER}@<PRIVATE_HOST> -p 30001
hostname: <PRIVATE_HOST>
workdir: ${V2X_DATA_ROOT}/v2x_t1_attention
HEAL root: /data/jichengzhi_v2x/HEAL
torch env: /data/jichengzhi_v2x/t2venv/bin/python
TVM site: ${V2X_DATA_ROOT}/tvm310/lib/python3.10/site-packages
...
```text
${V2X_DATA_ROOT}/v2x_t1_attention/results/attention_p50_tvm_mixed_int8_measurement_all_fullval_v1.json
```
...
```text
${V2X_DATA_ROOT}/v2x_t1_attention/results/attention_p50_tvm_mixed_int8_measurement_mswin_fullval_v1.json
```
...
```text
${V2X_DATA_ROOT}/v2x_t1_attention/results/attention_p50_tvm_mixed_int8_measurement_mswin_w8a16_fullval_v1.json
```
...
```text
${V2X_DATA_ROOT}/v2x_t1_attention/logs/attention_e2e_pq_v1/attention-p50-shortft-fp16_h800_check_latency_v1.json
${V2X_DATA_ROOT}/v2x_t1_attention/logs/attention_e2e_pq_v1/attention-p50-shortft-fp16_h800_check_ap_v1.json
```
...
export V2X_REPO_ROOT=${V2X_DATA_ROOT}/v2x_t1_attention
export V2X_HEAL_ROOT=/data/jichengzhi_v2x/HEAL
export V2XVIT_CKPT_DIR=${V2X_DATA_ROOT}/v2x_t1_attention/checkpoints/HeterBaseline_DAIR_lidar_v2xvit_2023_09_09_11_19_26
export V2X_PYTHON=/data/jichengzhi_v2x/t2venv/bin/python
PYTHONPATH=${V2X_DATA_ROOT}/v2x_t1_attention/scripts/phase2:/data/jichengzhi_v2x/t2lib:/data/jichengzhi_v2x/HEAL \
...
out = Path("${V2X_DATA_ROOT}/v2x_t1_attention/results/attention_baseline_pytorch_h800_check_v1.json")
...
```bash
PYTHONPATH=${V2X_DATA_ROOT}/v2x_t1_attention/scripts/phase2 \
...
export LD_LIBRARY_PATH=${V2X_DATA_ROOT}/tvm310/lib/python3.10/site-packages/tvm:${V2X_DATA_ROOT}/tvm310/lib/python3.10/site-packages/tvm/lib:${V2X_DATA_ROOT}/tvm310/lib/python3.10/site-packages/tvm_ffi:$(cat ${V2X_DATA_ROOT}/tvm_nvlibs.path)
export V2X_REPO_ROOT=${V2X_DATA_ROOT}/v2x_t1_attention
export V2X_HEAL_ROOT=/data/jichengzhi_v2x/HEAL
export V2XVIT_CKPT_DIR=${V2X_DATA_ROOT}/v2x_t1_attention/checkpoints/HeterBaseline_DAIR_lidar_v2xvit_2023_09_09_11_19_26
export PYTHONPATH=${V2X_DATA_ROOT}/v2x_t1_attention/scripts/phase2:/data/jichengzhi_v2x/t2lib:/data/jichengzhi_v2x/HEAL
```

连接纪律：

- 不要把远程密码写进文档、命令或最终汇报。
- 使用 `password-based SSH (disabled; use an SSH key)` 环境变量，并从已有 design 文档解析。
