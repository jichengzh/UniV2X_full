...
```bash
sshpass -p '<H800_PASSWORD>' ssh -p 30001 -o ConnectTimeout=45 -o StrictHostKeyChecking=no jichengzhi@222.95.84.215
```

- 若需跑 H800 TVM: 使用 `/exdata/jichengzhi/tvm310/bin/python`; GPU 只允许 4/5/6, 用前 `nvidia-smi` 确认 idle。
