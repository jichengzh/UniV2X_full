...
**分工**:**hw-optimizer**(H800/TVM 调优专长)。环境:`ssh -p 30001 ${V2X_REMOTE_USER}@<PRIVATE_HOST>`(pw 12345678);tuner `${V2X_DATA_ROOT}/s2_tvm/s2_2e_bumped.py`;python `${V2X_DATA_ROOT}/tvm310/bin/python`。
...
**前置(大工程)**:Pyramid→V2Xverse 移植完成 + CARLA <PRIVATE_HOST> 装好(本机/H800 未装)。见 [[heal_v2xverse_migration_design_v1]] / `HANDOFF_pyramid_v2xverse_migration_v1.md`。
**步骤**:
