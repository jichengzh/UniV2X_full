...
### 连接
`sshpass -p '12345678' ssh -p 30001 -o StrictHostKeyChecking=no jichengzhi@222.95.84.215` (密码每会话确认; repo=`/data/jichengzhi_v2x/V2Xverse`)
...
### 本机 /home/jichengzhi/V2X/multi_agent/real_test/
...
`/home/jichengzhi/V2Xverse/results/results_driving_mr_te{0,219}_r{N}/v2x_final/town05_short_collab/r{N}_repeat0/ego_vehicle_0/results.json`
