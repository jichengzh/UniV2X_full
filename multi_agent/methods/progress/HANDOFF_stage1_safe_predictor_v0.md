...
本轮已使用 H800 `/exdata/jichengzhi/tvm310` 跑完两个 `MEASUREMENT_BACKLOG_RUNNER_REQUIRED` 项：
...
- remote JSON: `/exdata/jichengzhi/s2_tvm/results/stage1_s2_anchor_scan_v1_20260623_2110.json`
...
- remote: `/exdata/jichengzhi/s2_tvm/results/stage1_model_predict_h800/stage1_s2_h800_p50_smoke_20260623_2031.log`
...
CUDA_VISIBLE_DEVICES=6 /exdata/jichengzhi/tvm310/bin/python \
  /exdata/jichengzhi/s2_tvm/stage1_s2_anchor_runner.py \
  --out-json /exdata/jichengzhi/s2_tvm/results/stage1_s2_anchor_scan_v1_20260623_2110.json \
  --work-root /exdata/jichengzhi/s2_tvm/ms_work/stage1_s2_anchor_scan_v1_20260623_2110 \
  --trials 4 \
  --reps 20 \
  --batches 1,2 \
  --anchors all
...
# 已在 H800 运行；日志已拉回本地。
CUDA_VISIBLE_DEVICES=6 /exdata/jichengzhi/tvm310/bin/python \
  /exdata/jichengzhi/s2_tvm/s2_2_probe.py \
  /exdata/jichengzhi/s2_tvm/models/p50_backbone.onnx \
  /exdata/jichengzhi/s2_tvm/ms_work/stage1_s2_h800_p50_smoke_20260623_2031 \
  8
```
