...
- H800 TVM env + 资产: `${V2X_DATA_ROOT}/tvm310/bin/python` + `${V2X_DATA_ROOT}/s2_tvm/models/{base,p50,trap25}_backbone.onnx`(+codriving_cache)。SSH `-p 30001 ${V2X_REMOTE_USER}@<PRIVATE_HOST>`(12345678)。
