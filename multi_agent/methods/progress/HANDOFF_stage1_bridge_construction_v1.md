...
### 1.1 唯一事实源 = 设计文档(先读)
`/home/jichengzhi/V2X/multi_agent/methods/design/bridge_stage1_to_search_design_v1.md`
...
- 若需跑 H800 TVM: ssh `sshpass -p 12345678 ssh -p 30001 -o ConnectTimeout=45 -o StrictHostKeyChecking=no jichengzhi@222.95.84.215`; python `/exdata/jichengzhi/tvm310/bin/python`; **GPU 只允许 4/5/6**(用前 nvidia-smi 确认 idle)。
- conda python: `/home/jichengzhi/miniconda3/envs/UniV2X_2.0/bin/python` + `PYTHONPATH=/home/jichengzhi/V2X`。
