...
```text
rsync exits 0
H800:/home/jichengzhi/V2X contains updated scripts and coverage_pipeline_v1
```
...
sshpass -e ssh -p 30001 \
  ...
  'cd /home/jichengzhi/V2X && hostname && pwd && python3 --version && nvidia-smi --query-gpu=index,name,utilization.gpu,memory.used,memory.total,power.draw,pstate --format=csv && nvidia-smi pmon -c 1'
unset SSHPASS
```
...
```text
hostname contains zs-nj-tap-gpu18
pwd is /home/jichengzhi/V2X
...
```text
h800_artifact_inventory_v1.txt contains ONNX and MetaSchedule DB paths under /exdata/jichengzhi/s2_tvm
```
...
python3 scripts/stage2_plan_artifact_tasks.py \
  ...
  --artifact-root /exdata/jichengzhi/s2_tvm \
...
H800 HEAL path: /home/jichengzhi/heal_research/HEAL/dataset/my_dair_v2x/v2x_c/cooperative-vehicle-infrastructure
H800 preferred storage: /exdata/jichengzhi/DAIR-V2X/DAIR-V2X-C/cooperative-vehicle-infrastructure
