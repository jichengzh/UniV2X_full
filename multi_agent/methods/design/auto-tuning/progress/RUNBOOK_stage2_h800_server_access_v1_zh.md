...
| 项 | 值 |
|---|---|
| SSH host | `222.95.84.215` |
| SSH port | `30001` |
| SSH user | `jichengzhi` |
| 已验证 hostname | `zs-nj-tap-gpu18` |
| GPU | 8 x NVIDIA H800, 每卡约 81559 MiB |
| 主要远端工作目录 | `/home/jichengzhi/V2X` |
| TVM/H800 artifact 根目录 | `/exdata/jichengzhi/s2_tvm` |
| TVM Python | `/exdata/jichengzhi/tvm310/bin/python` |

安全约束:

1. 不要把 H800 密码写入仓库、job plan、脚本或日志。
2. 需要非交互登录时使用环境变量 `SSHPASS`, 命令结束后 `unset SSHPASS`。
...
export LD_LIBRARY_PATH=/exdata/jichengzhi/tvm310/lib/python3.10/site-packages/nvidia/cuda_runtime/lib:/exdata/jichengzhi/tvm310/lib/python3.10/site-packages/tvm/lib:$LD_LIBRARY_PATH
```

常用 artifact 路径:

```text
/exdata/jichengzhi/s2_tvm/models
/exdata/jichengzhi/s2_tvm/ms_work_2e_base
/exdata/jichengzhi/s2_tvm/ms_work_2e_p50
/exdata/jichengzhi/s2_tvm/ms_work_2e_p75_retest
/exdata/jichengzhi/s2_tvm/ms_work_2e_trap25
/exdata/jichengzhi/s2_tvm/ms_work_2e_pad64_retest
/exdata/jichengzhi/s2_tvm/ms_work_2e_iso_s0_retest
/exdata/jichengzhi/s2_tvm/ms_work_2e_iso_s1_retest
/exdata/jichengzhi/s2_tvm/ms_work_2e_iso_s2_retest
/exdata/jichengzhi/s2_tvm/ms_bumped_s0_16
/exdata/jichengzhi/s2_tvm/ms_bumped_s0_32
/exdata/jichengzhi/s2_tvm/ms_bumped_s1_32
/exdata/jichengzhi/s2_tvm/ms_bumped_s2_64
/exdata/jichengzhi/s2_tvm/ms_bumped_s2_128_v2
/exdata/jichengzhi/s2_tvm/ms_bumped_mix_a
/exdata/jichengzhi/s2_tvm/ms_bumped_mix_b
/exdata/jichengzhi/s2_tvm/ms_bumped_mix_c
/exdata/jichengzhi/s2_tvm/ms_bumped_mix_d
/exdata/jichengzhi/s2_tvm/ms_bumped_mix_e
```

注意:

1. 远端 `/home/jichengzhi/V2X` 可能是 rsync 工作副本, 不一定是权威 git repo。
2. 本地 `/home/jichengzhi/V2X` 是文档和脚本编辑的主路径; 改脚本后需要显式 rsync 到 H800。
...
Connection closed by 222.95.84.215 port 30001
```
