...
ssh -p 30001 -o StrictHostKeyChecking=accept-new -o ConnectTimeout=60 ${V2X_REMOTE_USER}@<PRIVATE_HOST> \
  'cd ${V2X_ROOT} && BASE=multi_agent/data/stage2_lut_generation_v1/generated/overnight_6h_20260626 && python3 -m json.tool "$BASE/exports/current_experiment_report_v1.json" | sed -n "1,120p"'
