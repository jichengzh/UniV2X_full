...
```json
{
  ...
  "onnx_path": "${V2X_DATA_ROOT}/s2_tvm/models/mix_a_backbone.onnx",
  "tvm_work_dir": "${V2X_DATA_ROOT}/s2_tvm/ms_bumped_mix_a",
  "database_workload_path": "${V2X_DATA_ROOT}/s2_tvm/ms_bumped_mix_a/database_workload.json",
  "database_tuning_record_path": "${V2X_DATA_ROOT}/s2_tvm/ms_bumped_mix_a/database_tuning_record.json",
