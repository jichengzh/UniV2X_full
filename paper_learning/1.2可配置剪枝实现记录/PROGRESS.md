...
| 2026-04-19 | **D.2 联合量化 168 samples 全量结果出炉**：D.2.2 S1+INT8 AMOTA 0.287; **D.2.7 解耦+INT8 AMOTA 0.360**（仅掉 0.007 vs FP32） |
| 2026-04-19 | TRT 剪枝 engine 诊断继续：排除 img size bug 后 FP32 engine 也崩 → ONNX export 的 BEVEncoderWrapper trace 问题，需深入逐算子调试 |
