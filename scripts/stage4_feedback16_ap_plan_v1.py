#!/usr/bin/env python3
"""Build numerical-sanity and full-AP jobs for the Stage4 Feedback16 batch."""
...
SOURCE_SCHEMA = "stage4_feedback16_manifest_v1"
SCHEMA_VERSION = "stage4_feedback16_ap_plan_v1"


def build_feedback16_ap_plan(
...
def main() -> int:
    ...
    return 0 if counts == {"ready": 16} else 1
