...
def ensure_raw_seed_dir(seed: int, raw_template: Path) -> Path:
    """Create models/dataset_a_cache_g8/noise_p97_seed{N}/ from raw template."""
    seed_dir = REPO / f"models/dataset_a_cache_g8/noise_p97_seed{seed}"
...
def main():
    ...
    # Step 2: copy raw to noise_p97_seed{N} per seed
