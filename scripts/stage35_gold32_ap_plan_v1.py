#!/usr/bin/env python3
"""Build the Gold32 backend numerical-sanity and full-AP execution plan."""
...
SCHEMA_VERSION = "stage35_gold32_ap_plan_v1"


def build_gold32_ap_plan(
